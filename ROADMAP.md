...
- Current static asset cache version is `20260511-09`; bump this version whenever `app.js` or `styles.css` changes.
...
| 녹음 파일 간편 편집기 | `/tools/audio-editor/` | 녹음 파일 편집, 오디오 자르기, m4a 자르기, 휴대폰 녹음 편집 | M | Shipped browser-only waveform editor for common phone recordings such as m4a, aac, mp3, and wav when the browser can decode them. Supports selection delete/keep/copy/paste, undo/redo, volume adjustment, and exports edited audio as WAV without uploading recordings to the application server. |
